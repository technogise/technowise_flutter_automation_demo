...
GenericWhen2 scrollUntillTextVisible(){
  return when2(r'I scroll {string} down until {string} is visible', (context,String scrollableList, String targetPersona) async {
...
GenericWhen1 verifyPersonaList(){
  return when1(r'the following list of persons should be displayed', (context,Table personsTable) async {
